...
protected void move_skus_same_batch()
{
	...
	CParameters lstdata = new CParameters();
	...
	for(int i = 0; i < total; ++i)
	{
		...
		for (int j = 0; j < cols; ++j, ++letter)
		{
			...
			switch(j)
			{   // buscamos solamente las columnas que son necesarias
...
protected void loadinfoplan()
{
	...
	// checamos que no haya informacion anteriormente en thdr, batch_header, batch_detail, tdtml, tqchdr2, moldinv
...
protected void upload_plan_production()
{
	...
	CParameters exedata = new CParameters(values.get(defs.ZEXEDAT));
